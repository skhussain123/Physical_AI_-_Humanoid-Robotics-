...
SITEMAP_URL = "https://physical-ai-humanoid-robotics-5pyh.vercel.app/sitemap.xml"
...
def get_all_urls(sitemap_url):
    ...
    for child in root:
        ...
        if loc_tag is not None:
            # Replace gamma-ten domain with actual domain
            url = loc_tag.text.replace("https://physical-ai-humanoid-robotics-gamma-ten.vercel.app/", "https://physical-ai-humanoid-robotics-5pyh.vercel.app/")
            urls.append(url)
...
def save_chunk_to_qdrant(chunk, chunk_id, url):
    try:
        ...
        print(f"[ERROR] Failed to save chunk {chunk_id} to Qdrant: {str(e)}")
        return False
...
def ingest_book():
    ...
    for url in urls:
        ...
        # Add a small delay between processing URLs to avoid overwhelming the server
        time.sleep(1)
